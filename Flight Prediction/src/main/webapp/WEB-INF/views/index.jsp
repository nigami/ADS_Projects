        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <a href="flightPrediction.htm"><h4 class="service-heading">Flight Price Predictions</h4></a>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Classification</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <img class="img-responsive img-centered" src="<c:url value="/resources/img/portfolio/roundicons-free.png"/>" alt="">
