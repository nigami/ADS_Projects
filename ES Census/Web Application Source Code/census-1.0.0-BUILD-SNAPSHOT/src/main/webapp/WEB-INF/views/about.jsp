			...
			<div class="container">
				<div class="fh5co-text-wrap animate-box">
					<div class="fh5co-intro-text">
						<h1>Architecture used for Integration</h1>
						<h2></h2>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row row-bottom-padded-sm animate-box">
							<div class="col-md-3">
								<h3 class="fh5co-section-heading"> Architecture Used</h3>
							</div>
							<div class="col-md-9">
								<p class="fh5co-lead">
								Integration with Microsoft Azure , Tableau, and AWS Elastic Bean Stalk</p>	</div>
						</div>
